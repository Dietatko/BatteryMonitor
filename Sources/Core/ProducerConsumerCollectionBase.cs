...
namespace ImpruvIT.BatteryMonitor
{
	...
	internal sealed class IProducerConsumerCollection_DebugView<T>
	{
		...
		public T[] Values { get { return this.m_collection.ToArray(); } }
	}
	...
	{
		private readonly IProducerConsumerCollection<T> m_contained;
		...
		protected ProducerConsumerCollectionBase(IProducerConsumerCollection<T> contained)
		{
			...
			this.m_contained = contained;
		}

		/// <summary>Gets the contained collection.</summary>
		protected IProducerConsumerCollection<T> ContainedCollection { get { return this.m_contained; } }
		...
		protected virtual bool TryAdd(T item) { return this.m_contained.TryAdd(item); }
		...
		/// </returns>
		protected virtual bool TryTake(out T item) { return this.m_contained.TryTake(out item); }
		...
		public int Count { get { return this.m_contained.Count; } }

		/// <summary>Creates an array containing the contents of the collection.</summary>
		/// <returns>The array.</returns>
		public T[] ToArray() { return this.m_contained.ToArray(); }
		...
		public void CopyTo(T[] array, int index) { this.m_contained.CopyTo(array, index); }

		/// <summary>Copies the contents of the collection to an array.</summary>
		/// <param name="array">The array to which the data should be copied.</param>
		/// <param name="index">The starting index at which data should be copied.</param>
		void ICollection.CopyTo(Array array, int index) { this.m_contained.CopyTo(array, index); }

		/// <summary>Gets an enumerator for the collection.</summary>
		/// <returns>An enumerator.</returns>
		public IEnumerator<T> GetEnumerator() { return this.m_contained.GetEnumerator(); }
		...
		bool ICollection.IsSynchronized { get { return this.m_contained.IsSynchronized; } }

		/// <summary>Gets the synchronization root object for the collection.</summary>
		object ICollection.SyncRoot { get { return this.m_contained.SyncRoot; } }
	}
}
